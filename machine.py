...
class coffee:
    ...
    def add_new_coffee(self):
            ...
            coffeeditails.append([self.name, self.price, self.orgin, self.mix, self.stock])
            print("New coffee type added successfully")


coffeeditails = [["Latte", 250, "USA", "Milkkmix", 20],
    ...
    try:
        ...
        if userinput < siz_coffee_index():
            ...
            if coines > coffeeditails [userinput][1]:
                ...
                print("Take your remain {}".format(coines - coffeeditails [userinput][1]))
                print("Enjoy !!!")
            else:
...
def menu():
    ...
    try:
        coine = int(input("Enter your step :"))
